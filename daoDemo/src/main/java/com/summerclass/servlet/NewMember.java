...
public class NewMember extends ServletBase
{
    ...
    private void collectInputs( PrintWriter out, String message )
    {
        ...
        out.println( "    <table> " +
                     ...
                     "        <tr> " +
                     "            <td><span title='Required field'>*</span></td> " +
                     "            <td><label for='firstName'>User Name</label></td> " +
                     "            <td><input type='text' id='userName' name='userName' value='' maxlength='50'/></td> " +
                     "        </tr> " +
                     "        <tr> " +
                     "            <td><span title='Required field'>*</span></td> " +
                     "            <td><label for='password'>Password</label></td> " +
                     "            <td><input type='password' id='password' name='password' value='' maxlength='50'/></td> " +
                     "        </tr> " );
