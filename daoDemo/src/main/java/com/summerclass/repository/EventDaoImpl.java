...
public class EventDaoImpl implements EventDao
{
    ...
    {
        String eventTypeId = RandomGenerator.getGuid();

        String sql = "insert into eventTypes( et_id, et_name ) values ( :eventTypeId, :eventTypeName )";

        MapSqlParameterSource source = new MapSqlParameterSource();
        source.addValue( "eventTypeId", eventTypeId );
        source.addValue( "eventTypeName", eventType.getEventName() );
