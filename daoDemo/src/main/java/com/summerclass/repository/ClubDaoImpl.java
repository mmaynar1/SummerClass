...
public class ClubDaoImpl implements ClubDao
{
    ...
    public String getClubName( String clubId )
    {
        ...
        if ( StringSupport.isGuid( clubId ) )
        {
            ...
            clubName = jdbc.queryForObject( sql, source, String.class );
        }
    ...
    @Override
    public Club getClub( int clubNumber )
    {
        String sql = "select c.c_id id, c.c_name name, c.c_number number from clubs c where c.c_number = :number";

        MapSqlParameterSource source = new MapSqlParameterSource( "number", clubNumber );
