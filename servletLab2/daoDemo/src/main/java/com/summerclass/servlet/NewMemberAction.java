...
public class NewMemberAction extends ServletBase
{
    ...
    public void doPost( HttpServletRequest request, HttpServletResponse response ) throws ServletException, IOException
    {
        ...
        if ( isValid( firstName, lastName, agreementTypeId ) )
        {
            try
            {
                MemberDao memberDao = getMemberDao();
                String memberId = memberDao.createMember( firstName, lastName, agreementTypeId );
    ...
    private boolean isValid( String firstName, String lastName, String agreementTypeId )
    {
