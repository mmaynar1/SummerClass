...
insert into members (m_id, m_first_name, m_last_name, at_id ) values( getGuid(), 'Kenneth', 'Teeter', (select at_id from agreementTypes where at_abc_code = 'GOLD') );
insert into members (m_id, m_first_name, m_last_name, at_id ) values( getGuid(), 'Leon', 'Brunett', (select at_id from agreementTypes where at_abc_code = 'SILVER') );
insert into members (m_id, m_first_name, m_last_name, at_id ) values( getGuid(), 'Marty', 'Canton', (select at_id from agreementTypes where at_abc_code = 'GOLD') );
insert into members (m_id, m_first_name, m_last_name, at_id ) values( getGuid(), 'Nathan', 'Garrett', (select at_id from agreementTypes where at_abc_code = 'BRONZE') );
insert into members (m_id, m_first_name, m_last_name, at_id ) values( getGuid(), 'Opie', 'McFarlan', (select at_id from agreementTypes where at_abc_code = 'GOLD') );
insert into members (m_id, m_first_name, m_last_name, at_id ) values( getGuid(), 'Pam', 'Ryan', (select at_id from agreementTypes where at_abc_code = 'SILVER') );
insert into members (m_id, m_first_name, m_last_name, at_id ) values( getGuid(), 'Ray', 'Reaves', (select at_id from agreementTypes where at_abc_code = 'GOLD') );
insert into members (m_id, m_first_name, m_last_name, at_id ) values( getGuid(), 'Samuel', 'Harris', (select at_id from agreementTypes where at_abc_code = 'BRONZE') );
insert into members (m_id, m_first_name, m_last_name, at_id ) values( getGuid(), 'Todd', 'Albright', (select at_id from agreementTypes where at_abc_code = 'GOLD') );
insert into members (m_id, m_first_name, m_last_name, at_id ) values( getGuid(), 'Venus', 'McQray', (select at_id from agreementTypes where at_abc_code = 'GOLD') );
