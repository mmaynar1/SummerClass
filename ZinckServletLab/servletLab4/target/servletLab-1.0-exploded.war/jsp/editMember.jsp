...
<div class="container">
    ...
    <form:form id="editMemberForm" modelAttribute="member" action="editMember.spr" method="post">
        ...
        <table>
            ...
            <tr>
                <td colspan="2">
                    <input type="button" name="editMemberButton" id="editMemberButton" value="Edit Member"/>
                </td>
            </tr>
        </table>
    </form:form>
