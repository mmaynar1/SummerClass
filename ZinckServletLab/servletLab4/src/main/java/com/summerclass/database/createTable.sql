...
(
  ...
  e_barcode varchar(25) not null unique,
  e_address varchar(100),
  e_city varchar(25) ,
  e_state char(2),
  e_zip_code char(5) ,
  e_hourly_wage int,
  e_start_date timestamp,
  primary key( e_id )
);

insert into employees  (e_id, e_first_name, e_last_name, e_barcode, e_address, e_city, e_state, e_zip_code, e_hourly_wage, e_start_date ) values( getGuid(), 'Andy', 'Smith', 'a0', '123 Street', 'Sherwood', 'AR','72120','15', now()  );
insert into employees  (e_id, e_first_name, e_last_name, e_barcode, e_address, e_city, e_state, e_zip_code, e_hourly_wage, e_start_date ) values( getGuid(), 'Bob', 'Jones','a1', '123 Street', 'Sherwood', 'AR','72120','15', now() );
insert into employees  (e_id, e_first_name, e_last_name, e_barcode, e_address, e_city, e_state, e_zip_code, e_hourly_wage, e_start_date ) values( getGuid(), 'Charles', 'Wood', 'a2', '123 Street', 'Sherwood', 'AR','72120','15', now() );
insert into employees  (e_id, e_first_name, e_last_name, e_barcode, e_address, e_city, e_state, e_zip_code, e_hourly_wage, e_start_date ) values( getGuid(), 'Dan', 'Small', 'a3', '123 Street', 'Sherwood', 'AR','72120','15', now() );
insert into employees  (e_id, e_first_name, e_last_name, e_barcode, e_address, e_city, e_state, e_zip_code, e_hourly_wage, e_start_date ) values( getGuid(), 'Ellen', 'Oak', 'a4', '123 Street', 'Sherwood', 'AR','72120','15', now() );
insert into employees  (e_id, e_first_name, e_last_name, e_barcode, e_address, e_city, e_state, e_zip_code, e_hourly_wage, e_start_date ) values( getGuid(), 'Farah', 'Waters', 'a5', '123 Street', 'Sherwood', 'AR','72120','15', now() );
insert into employees  (e_id, e_first_name, e_last_name, e_barcode, e_address, e_city, e_state, e_zip_code, e_hourly_wage, e_start_date ) values( getGuid(), 'Gloria', 'Johnson', 'a6', '123 Street', 'Sherwood', 'AR','72120','15', now() );
insert into employees  (e_id, e_first_name, e_last_name, e_barcode, e_address, e_city, e_state, e_zip_code, e_hourly_wage, e_start_date ) values( getGuid(), 'Heather', 'Mall', 'a7', '123 Street', 'Sherwood', 'AR','72120','15', now() );
insert into employees  (e_id, e_first_name, e_last_name, e_barcode, e_address, e_city, e_state, e_zip_code, e_hourly_wage, e_start_date ) values( getGuid(), 'Isis', 'Eathan', 'a8', '123 Street', 'Sherwood', 'AR','72120','15', now() );
insert into employees  (e_id, e_first_name, e_last_name, e_barcode, e_address, e_city, e_state, e_zip_code, e_hourly_wage, e_start_date ) values( getGuid(), 'Jackiet', 'Kennedy', 'a9', '123 Street', 'Sherwood', 'AR','72120','15', now() );
